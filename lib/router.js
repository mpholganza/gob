...
Router.map(function() {
  ...
  this.route('adminBuildingCreate', {path: 'admin/building_create'});
  this.route('adminDealCreate', {path: 'admin/deal_create'});
  this.route('adminPromoCreate', {path: 'admin/promo_create'});
  this.route('ordersList', {path: 'admin/orders_list'});
  ...
  this.route('pathToText', {
    ...
    action: function() {
      ...
      if (requestType === "POST") {
        Texting.textDispatcher(textFrom, textBody);
      }
    }
  });
});