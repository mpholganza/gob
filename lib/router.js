...
Router.map(function() {
  ...
  this.route('buildingCreate', {
    path: 'admin/building_create',
    waitOn : function () {
      return Meteor.subscribe('userData');
    },
    data : function () {
  ...
  this.route('dealCreate', {
    path: 'admin/deal_create',
    waitOn : function () {
      return Meteor.subscribe('userData');
    },
    data : function () {
  ...
  this.route('promoCreate', {
    path: 'admin/promo_create',
    waitOn : function () {
      return Meteor.subscribe('userData');
    },
    data : function () {
